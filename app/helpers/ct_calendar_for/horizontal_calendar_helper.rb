module CtCalendarFor
  module HorizontalCalendarHelper
    ...
    def horizontal_calendar options
      ...
      content_tag :div, class: "row" do
        content_tag :div, class: "col-12" do
          content_tag :table, class: "horizontal_table" do
      ...
      content_tag :tr do
        ...
        for i in 0..@months_span
          ...
          month_days = if @months_span.zero?
            ...
            (@end_date.to_date - @end_date.to_date.beginning_of_month).to_i
          elsif i.zero?
            (@start_date.to_date.end_of_month - @start_date.to_date).to_i
          else
            (@start_date.to_date.since(i.months).end_of_month - @start_date.to_date.since(i.months).beginning_of_month).to_i
          end
    ...
    def horizontal_body options
      ...
      content_tag :tr, class: "highlighted-row" do
    ...
    def user_lines
      ...
      @users.each do |user|
        content_tag :tr do
          concat content_tag :td, user.name, {colspan: 10, class: "cell-name pl-3 #{'corner-bottom-left-radius' if user == @users.last}"}
          (@start_date.to_date..@end_date.to_date).each do |date|
            concat content_tag :td, class: "" do
              content_tag(:div, nil,class: "hz-calendar-ball")
            end
          end
        end
      end
